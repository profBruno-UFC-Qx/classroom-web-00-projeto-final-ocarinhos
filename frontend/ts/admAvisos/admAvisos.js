...
const searchInput = document.querySelector(".avisosSearchField input");
...
const overlay = document.querySelector(".avisosModalOverlay");
const modalTitle = document.querySelector("[data-modal-title]");
const modalEyebrow = document.querySelector("[data-modal-eyebrow]");
const modalDescription = document.querySelector("[data-modal-description]");
const modalForm = document.querySelector(".avisosModalForm");
...
const tituloInput = modalForm?.querySelector('input[name="titulo"]') ?? null;
const descInput = modalForm?.querySelector('textarea[name="desc"]') ?? null;
const dataInput = modalForm?.querySelector('input[name="data"]') ?? null;
...
function getFilteredAvisos() {
    ...
    const filtered = todosAvisos.filter((aviso) => {
        ...
        return (normalizeText(aviso.titulo).includes(query) ||
...
function ensureCurrentPage(pageCount) {
...
function setSortLabel() {
    ...
    sortButton.setAttribute("aria-pressed", currentSort === "asc" ? "true" : "false");
    sortButton.title = currentSort === "desc" ? "Mais recentes" : "Mais antigos";
}
function openModal(aviso) {
...
async function salvarAviso(formData) {
    const payload = {
